...
namespace Dna.CodingChallenge.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CodingChallengeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CodingChallengeEfCoreEntityExtensionMappings to extend the IdentityUser entity
